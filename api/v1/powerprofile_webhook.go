...
// +kubebuilder:webhook:path=/validate-power-openshift-io-v1-powerprofile,mutating=false,failurePolicy=fail,sideEffects=None,groups=power.openshift.io,resources=powerprofiles,verbs=create;update;delete,versions=v1,name=vpowerprofile.kb.io,admissionReviewVersions=v1
