# Cluster Power Manager Project Governance

The Cluster Power Manager project is dedicated to providing Kubernetes-native
power management capabilities for cluster workloads. This governance explains
...
The Cluster Power Manager project and its leadership embrace the following values:
...
Cluster Power Manager Maintainers have write access to the
[project GitHub repository](https://github.com/cluster-power-manager/cluster-power-manager).
They can merge patches from others, but not their own. The current maintainers
can be found in [CODEOWNERS](./.github/CODEOWNERS). Maintainers collectively
manage the project's resources and contributors.

This privilege is granted with some expectation of responsibility: maintainers
are people who care about the Cluster Power Manager project and want to help it
...
Issue or Discussion. A simple majority vote of existing Maintainers approves the
application. Maintainer nominations will be evaluated without prejudice to
...
There are currently no regular project meetings. If meetings are established in
the future, this section will be updated with details.

Maintainers will have closed meetings in order to discuss security reports or
...
discussed and resolved by the Maintainer Council. If a Maintainer is directly
involved in the report, the remaining Maintainers will designate two Maintainers
to work on resolving it.

## Security Response Team

Security reports are currently handled by the Maintainer Council directly. If
the project grows, the Maintainers may appoint a dedicated Security Response
Team of at least two contributors to handle this responsibility.

The Maintainers are responsible for handling all reports of security holes and
breaches.

## Voting

While most business in Cluster Power Manager is conducted by
"[lazy consensus](https://community.apache.org/committers/lazyConsensus.html)",
periodically the Maintainers may need to vote on specific actions or changes.
A vote can be taken via GitHub Issues or Discussions, or during a developer
